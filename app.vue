...
.hl {
  ...
  background: linear-gradient(transparent 58%, var(--green) 58% 92%, transparent 92%);
...
.leaderboard-section {
  ...
  background: linear-gradient(180deg, #fbf6ec, #f2e7da);
}
...
.site-footer > strong {
  ...
  color: transparent;
  background: linear-gradient(180deg, rgba(20, 36, 26, 0.92), rgba(20, 36, 26, 0.4));
